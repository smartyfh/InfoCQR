...
if __name__ == "__main__":
    split = 'test'
    root = 'datasets/qrecc/'
    lines = json.load(open(os.path.join(root, f'{split}_fused_ICL_post.json'), "r", encoding="utf-8"))
    
    with jsonlines.open(os.path.join(root, f'{split}_chatgpt_ICL_editor.jsonl'), mode='a') as writer:
